...
export default function Header() {
  ...
  return (
    <div className={`grid grid-cols-2 ${show? 'gap-y-6': 'gap-y-0'} gap-2 p-3 sm:p-5 duration-500 shadow-md px-5 sm:px-8 justify-between align-middle bg-primary`}>
        ...
        <div className={`flex sm:col-auto sm:flex-row sm:justify-self-end flex-col gap-1 duration-500 col-span-2 items-center ${!show? 'max-h-0 overflow-hidden': 'max-h-32'} justify-self-center`}>
